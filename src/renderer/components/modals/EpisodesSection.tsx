...
const EpisodesSection: React.FC<EpisodesSectionProps> = ({
  ...
  const history_entry = getAnimeHistory((listAnimeData.id || listAnimeData.media.id || listAnimeData.media.mediaListEntry && listAnimeData.media.mediaListEntry.id) as number);
